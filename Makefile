...
#-----------------------------------------------------------------------------
board_saved_files := lib/libwebviewchromium.so lib64/libwebviewchromium.so bin/bootanimation bin/shutdownanimation media/bootanimation.zip media/shutadownanimation.zip
...
override_property += \
    ro.flyme.romer=ruowei \
    ro.product.model_romer=Redmi_Note-2_ruowei
